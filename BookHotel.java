...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		la3.setBounds(35, 170, 200, 14);
		contentPane.add(la3);
                
                JLabel l11 = new JLabel();
		l11.setBounds(271, 170, 200, 14);
		contentPane.add(l11);
                
                
                JLabel la4 = new JLabel("Number of Days");
                la4.setBounds(35, 200, 200, 14);
		contentPane.add(la4);
                
		int defaultNumberOfDays = 5;
                JLabel l12 = new JLabel(Integer.toString(defaultNumberOfDays));
                l12.setBounds(271, 200, 150, 20);
                contentPane.add(l12);
                
		
		JLabel la5 = new JLabel("AC / Non-AC");
		la5.setBounds(35, 240, 200, 14);
		contentPane.add(la5);
                
                c2 = new Choice();
                c2.add("AC");
                c2.add("Non-AC");
                c2.setBounds(271, 240, 150, 30);
                add(c2);

                
		JLabel la6 = new JLabel("Food Included :");
		la6.setBounds(35, 300, 200, 14);
		contentPane.add(la6);
                
                c3 = new Choice();
                c3.add("Yes");
                c3.add("No");
                c3.setBounds(271, 300, 150, 30);
                add(c3);
		...
		lbl2.setBounds(35, 380, 200, 14);
		contentPane.add(lbl2);
                
                JLabel l3 = new JLabel();
		l3.setBounds(271, 380, 200, 14);
		contentPane.add(l3);
           	
		JLabel lbl3 = new JLabel("Phone :");
		lbl3.setBounds(35, 410, 200, 14);
		contentPane.add(lbl3);
                
                JLabel l4 = new JLabel();
		l4.setBounds(271, 410, 200, 14);
		contentPane.add(l4);

		
		JLabel lblDeposite = new JLabel("Total Price :");
		lblDeposite.setBounds(35, 440, 200, 14);
		contentPane.add(lblDeposite);
		
		JLabel l5 = new JLabel();
		l5.setBounds(271, 440, 200, 14);
		...
		contentPane.add(l5);
                ...
                try{
                    ...
                    while(rs.next()){
                     ...
                     ResultSet sr = c.s.executeQuery("select * from bookPackage where username = '"+username+"'");
                     while(sr.next()){
                         l11.setText(sr.getString("persons"));
			...
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                if(rs.next()){
                                    ...
                                    int persons = Integer.parseInt(l11.getText());
                                    int days = defaultNumberOfDays;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookHotel values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+l11.getText()+"','"+defaultNumberOfDays+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
                                c.s.executeUpdate(q1);
                                
                                
                                Paymenthotel payment = new Paymenthotel("");
